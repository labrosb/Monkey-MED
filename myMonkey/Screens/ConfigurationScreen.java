...
public class ConfigurationScreen implements Screen
{
    ...
    public static float speechBubbleHeight;
    public static float logoX;
    public static float logoY;
    public static float figureX;
    public static float figureY;
    public static float speechBubbleX;
    public static float speechBubbleY;
    public static float configurationFontSize;
    public static float configurationTextX;
    public static float configurationTextY;
